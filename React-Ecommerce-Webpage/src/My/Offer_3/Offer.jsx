            ...
            <div className="container" style={{ height: '545px' }}>
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <div className='rounded text-white position-relative' style={{ background: 'url(./img/offer-1.jpg) no-repeat center', backgroundSize: 'cover', height: '100%' }}>
                            <h3 className='d-flex align-items-center fw-bold position-absolute' style={{ fontSize: '55px', left: '5%', top: '2%' }}>50
                                <p className='fs-5 m-0 ps-1 pt-2 fw-normal'><span className='d-block'>%</span><span className='d-block'>OFF</span></p>
                            </h3>
                            <div className="position-absolute text-center p-4" style={{ width: '100%', left: '0', bottom: '0' }}>
                                <h4>Cake</h4>
                    ...
                    <div className="col-lg-4">
                        <div className='rounded text-white position-relative' style={{ background: 'url(./img/offer-2.jpg) no-repeat center', backgroundSize: 'cover', height: '100%' }}>
                            <h3 className='d-flex align-items-center fw-bold position-absolute' style={{ fontSize: '55px', left: '5%', top: '2%' }}>40
                                <p className='fs-5 m-0 ps-1 pt-2 fw-normal'><span className='d-block'>%</span><span className='d-block'>OFF</span></p>
                            </h3>
                            <div className="position-absolute text-center p-4" style={{ width: '100%', left: '0', bottom: '0' }}>
                                <h4>Milk</h4>
